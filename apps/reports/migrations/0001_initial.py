    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('success', models.IntegerField(help_text='成功总数', verbose_name='成功执行总数')),
                ('htlml', models.TextField(blank=True, help_text='报告HTML源码', null=True, verbose_name='报告HTML源码')),
                ('summary', models.TextField(blank=True, default=True, help_text='报告详情', null=True, verbose_name='报告详情')),
            ],
            options={
                'verbose_name': '测试报告',
